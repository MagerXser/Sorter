...
public class Quicksort<T extends Comparable<? super T>> implements Sorter<T> {
    ...
    public T[] quickSort (T[] A, int low, int high){
        if (low < high +1 ) {
    ...
    public void swap (T [] A, int index1, int index2) {
        T temp = A[index1];
        A[index1] = A[index2];
        A[index2] = temp;
    }
    ...
    public List <T> quickSortArrayList (List<T> A, int low, int high){
        if (low < high +1 ) {
    ...
    public int partitionArrayList (List<T> A, int low, int high){
    ...
    public void swapArrayList (List<T> A, int index1, int index2) {
        T temp = A.get(index1);
